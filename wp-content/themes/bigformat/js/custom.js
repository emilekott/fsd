...
(function($){
	...
	theme = {
	 ...
	 $.supersized.themeVars = {
		...
		image_path			:	'http://localhost:8888/flipside-dance/wp-content/themes/bigformat/images/',				// Default image path
...
jQuery('#portfoliocontainer').infinitescroll({
    ...
    loading: {
        ...
        img: 'http://localhost:8888/flipside-dance/wp-content/themes/bigformat/images/loading.gif',
